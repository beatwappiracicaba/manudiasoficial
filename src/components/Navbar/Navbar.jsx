  ...
  return (
    <motion.nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled ? 'bg-dark/90 backdrop-blur-xl shadow-2xl' : 'bg-transparent'
      }`}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <a href="#home" className="flex items-center gap-3 group">
            <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-gold/50 group-hover:border-gold transition-all duration-300">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              href="/login"
              className="px-6 py-2.5 rounded-full bg-gradient-to-r from-yellow-600 to-gold text-dark font-semibold text-sm hover:shadow-lg hover:shadow-gold/20 transition-all duration-300 hover:scale-105"
            >
              Login
            </a>
          </div>
